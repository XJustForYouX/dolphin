const float Filmic_Strength = 0.80; 
...
const float BaseCurve = 3.5; 
const float BaseGamma = 1.9; 
const float EffectGamma = 1.90;
...
void main() 
{
	...
	float EffectGammaR = 1.5; 
	float EffectGammaG = 1.5; 
	float EffectGammaB = 1.5; 
